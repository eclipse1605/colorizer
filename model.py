...
class ECCVColorizer(nn.Module):
    ...
    def __init__(self):
        ...
        # Encoder (Low level features extraction)
        ...
        # Output layer - predict a and b channels in the LAB color space
...
class SIGGRAPHColorizer(nn.Module):
    ...
    def __init__(self):
        ...
        # Low-level features network (processes grayscale image)
    ...
    def forward(self, x):
        ...
        # Expand global features to match the spatial dimensions of local features
        ...
        # Process through mid-level features
...
class ColorizationModelWithPerceptual(nn.Module):
    def __init__(self, base_model=None, vgg_features=None):
        ...
        # Initialize VGG features for perceptual loss (if provided)
    ...
    def forward(self, x, extract_features=False, is_training=False):
        ...
        # If VGG features are needed, we would compute them here
        # (We'll keep this simple for now and just return the ab prediction)
        return ab_pred
...
def create_model(use_perceptual=False, use_gan=False):
    ...
    discriminator = None
    if use_gan:
        # Create a PatchGAN discriminator for adversarial training
        discriminator = SIGGRAPHColorizer()  # Input is L+ab channels
